...
import { WhimsyError, ErrorTypes, replyUserError } from '../../utils/errorHandler.js';
        ...
        try {
            ...
            try {
                ...
                if (error instanceof WhimsyError) {
                    ...
                    logger.debug(`WhimsyError [${error.type}]: ${error.message}`, error.context || {});
                } else {
    ...
    try {
        ...
        collector.on('collect', async (buttonInteraction) => {
            try {
                ...
                const userMessage = error instanceof WhimsyError
