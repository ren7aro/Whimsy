...
import { WhimsyError, replyUserError, ErrorTypes } from '../../utils/errorHandler.js';
        ...
        .addComponents(
            new ActionRowBuilder().addComponents(
                new TextInputBuilder()
                    ...
                    .setMaxLength(2048)
                    .setRequired(false)
                    .setPlaceholder('Built with Whimsy'),
            ),
            new ActionRowBuilder().addComponents(
                new TextInputBuilder()
...
export default {
    ...
    async execute(interaction) {
        try {
            ...
            if (error instanceof WhimsyError) throw error;
