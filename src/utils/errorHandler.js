...
//
// Rules:
// 1. Commands/handlers: throw WhimsyError (via createError) or let errors propagate;
...
export function createError(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
    ...
    return new WhimsyError(message, type, userMessage, normalizedContext);
}
